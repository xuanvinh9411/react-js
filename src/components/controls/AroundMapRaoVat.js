                  ...
                  <div id="info-marker">
                    <div className="header-rel" style={{position:'relative'}}>
                      <h4 className="pull-left s-h4" >
                        <Link to={urlOnPage.shop.shopView + functionCommon.createSlug( props.infoMarker.name) + '-' +  props.infoMarker.id + '.html'}
                              onClick={()=>{
                    ...
                    <div className="img-result">
                      <div
                        onClick={()=>{
                          ...
                          browserHistory.push(urlOnPage.post.postViewPage + functionCommon.createSlug( props.infoMarker.name) + '-' +  props.infoMarker.id + '.html');
                        }}
                        style={{
