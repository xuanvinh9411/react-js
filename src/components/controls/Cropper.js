...
const Cropper = React.createClass({
    ...
    getInitialState() {
        let {originX, originY, selectionNatural, fixedRatio, allowNewSelection, rate, styles, imageLoaded, beforeImageLoaded} = this.props;
        let width=700;
        let height=305;
          return {
            img_width: '100%',
            ...
            selectionNatural,
            allowNewSelection,
            frameHeight: 305, //fixedRatio ? (width / rate) : height,
            dragging: false,
            maxLeft: 0,
            maxTop: 0,
            action: null,
    ...
    calcPosition(width, height, left, top, move){
        ...
        this.setState({imgLeft: 0, imgTop: top, imgWidth: 700, imgHeight: 305});
    },
    ...
    frameMove(e){
        ...
        this.calcPosition(/*frameWidth*/700, /*frameHeight*/305, _x, _y, true);
    },
    ...
    handleDragStop(e){
        if (this.state.dragging) {
            ...
            this.setState({
                originX: offsetLeft,
                originY: img_height - offsetHeight,/*offsetTop,*/
                dragging: false,
